...
function createWindow () {
	...
	try {
		...
		const configuredDisplayIndex = Number.isInteger(config.electronDisplay) ? config.electronDisplay : 0;
		const targetDisplay = displays[configuredDisplayIndex] || electron.screen.getPrimaryDisplay();
